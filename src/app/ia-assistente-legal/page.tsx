...
export default function IAAssistenteLegalPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-black text-slate-50">
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <h1 className="text-4xl font-bold mb-4">5. IA Assistente Legal</h1>
        <p className="text-lg text-slate-300 mb-8">Modelos de contratos, análise de riscos, checklist de due diligence e monitoramento de alterações legislativas.</p>
